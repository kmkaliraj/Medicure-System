...
<html>
<head>
<title>Registration Page For Reciptionist</title>
<script type="text/javascript" src="../../script/RecClientSideValid.js"></script>
</head>
<body>
	<h1>Registration For Reciptionist</h1>
	<form action="../../receptionist.up" method="post" name="frm">
		<table border="3" cellpadding="3" cellspacing="3" bordercolor="black">
			...
			<tr>
				...
				<th><input type="button" value="Validate"
					onclick="validateRec()"> <input type="submit" name="submit"
					id="sub" value="submit" disabled="disabled">
				</th>
			</tr>
		</table>
	</form>
