...
package com.medicure.ordermanagement.quotation.java;

import javax.servlet.http.HttpServletRequest;
import javax.servlet.jsp.JspException;
import javax.servlet.jsp.tagext.BodyTagSupport;

import com.medicure.ordermanagement.quotation.bean.QuoteBean;
    ...
    public int doStartTag() {
        ...
        for (Object j : quantity) {
            try {
                ...
                String val = "<tr>" + "<td>" + drugID[counter] + "</td>"
                        + "<td>" + drugNames[counter] + "</td>" + "<td>"
                        + quantity[counter] + "</td>"
                        + "<td><input type=\"text\" style=\"width: 30px;\" name=\"price" + counter
                        + "\"></td>" + "</tr>\n";
